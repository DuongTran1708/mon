...
echo "MERGING"
echo "*******"
python $DIR_SOURCE/utils/merge_result.py  \
    --results  \
        "/media/sugarubuntu/DataSKKU3/3_Dataset/AI_City_Challenge/2023/Track_5/aicity2023_track5/outputs_s1/final_result_s1.txt" \
        "/media/sugarubuntu/DataSKKU3/3_Dataset/AI_City_Challenge/2023/Track_5/aicity2023_track5/outputs_s2/final_result_s2.txt"
